...
<article class="mt-5 row">
	<article class="col-md-7 col-12 bg-light pro-input">
		<form:form action="${rootPath}/admin/dept/input" modelAttribute="deptVO">
			...
			<div class="form-group">
				<form:input path="d_addr" class="form-control" placeholder="거래처주소"/>
				<form:errors path="d_addr" class="in-errors"/>
			</div>
			
			<div class="form-group">
				<form:input path="d_manager" class="form-control" placeholder="담당자명"/>
			...
			<div class="form-group">
				...
				<form:errors path="d_remark" class="in-errors"/>
			</div>
	...
	<article class="col-md-4 col-12 bg-light list-body ">
		<%@ include file="/WEB-INF/views/admin/dept-list.jsp" %>
	</article>
