...
public class MailSendService {
	...
	private final String from_email = "kol2010@naver.com";
...
//	public boolean join_send(UserDetailsVO userVO) {
		...
		// localhost:8080/sec/join/email/admin/kol2010@naver.com
		/*
		...
		email_message.append("<p>회원가입 절차를 마무리하려면 ");
		email_message.append("email 인증을 하여야 합니다 <br/>");
		email_message.append("<p><a href='%s'>Email 인증</a> 링크를 클릭하세요");
//		email_message.append("<p><a href='" + email_link.toString()) + "');
		
		String send_message = String.format(email_message.toString(), email_link.toString());
		
		String to_email = email;
		String subject = "봄나라 회원 인증메일";
