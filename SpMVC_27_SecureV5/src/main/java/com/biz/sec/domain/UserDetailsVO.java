 ...
 * 
 * 2020-04-10
 * User 클래스를 상속받아 만든 UserVO를 UserDetails 인터페이스를 
 * implements한 UserDetailsVO로 변경
 * 
 * UserDetails를 implements 하면 method를 Override 하라는 지시가 있다
 * 하지만, method를 Override 하지 않고
...
public class UserDetailsVO implements UserDetails {
	 ...
	 * 이 과정을 serialize라고 하는데, 각 변환된 문자열리
	 * 서로 흐트러지지 않도록 설정하는 키 값
	 */
