...
public class AjaxController {
	...
	/*
	 * @ResponseBody
	 * 컨트롤러 method에서 return 하는 값을 변환없이 있는 그대로
	 * 보내라
	 * 
	 ...
	 * 단, jacksonbind를 pom.xml에 dependency를 설정해둬야 한다
	 */
	@ResponseBody
	 ...
	 * 문자열을 return 하고 해당하는 문자열.jsp파일을 views 폴더에서
