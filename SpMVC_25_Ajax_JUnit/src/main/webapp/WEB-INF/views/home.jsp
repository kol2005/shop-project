...
<script>
	/* 화면상의 DOM 객체가 모두 그려지기 전에 event 등을 설정하면
	 ...
	 화면상의 모든 tago에 의한 DOM이 완전히 그려진 다음
...
<body>
	...
	<section>
		<form action="saveUser" method="POST">
			...
			이 버튼이 form 안에 있으면 버튼을 클릭했을때 form 안의 input box에
			 입력한 값을 모두 모아서 action으로 지정된 url로 모두 전송하는 기능을 수행
			 button type="button"으로 지정하면 모양만 버튼이고 기본 기능을
			 수행하지 않도록 한다 -->
